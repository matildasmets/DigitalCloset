<x-layout>
        ...
        <div class="relative">
            ...
            <div class="gap-y-3">
                <p class="transition-all hover:ms-2 flex items-center"><a
                    ...
                    aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-put-outfit-together-modal"
                    data-hs-overlay="#hs-put-outfit-together-modal"><x-fas-arrow-right class="w-6 h-6 text-black mr-2" /> Put an outfit together</a></p>
    ...
    <div id="hs-put-outfit-together-modal"
        class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none"
        role="dialog" tabindex="-1" aria-labelledby="hs-put-outfit-together-modal-label">
        <div
            class="hs-overlay-animation-target hs-overlay-open:scale-100 hs-overlay-open:opacity-100 scale-95 opacity-0 ease-in-out transition-all duration-200 sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
            <div
                class="w-full flex flex-col bg-white border shadow-sm rounded-xl pointer-events-auto dark:bg-neutral-800 dark:border-neutral-700 dark:shadow-neutral-700/70">
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                    <h3 id="hs-put-outfit-together-modal-label" class="font-bold text-gray-800 dark:text-white">
                ...
                <div class="p-4 overflow-y-auto">
                    <form action="/dashboard/put-outfit-together" method="POST" id="hs-put-outfit-together-form">
                        ...
                        <div class="mb-4">
                            <label for="name"
                                class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ocassion</label>
                            <select name="occasion" id="occasion" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:placeholder-neutral-400 dark:text-white sm:text-sm" required>
