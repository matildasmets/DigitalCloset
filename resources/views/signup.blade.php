                        ...
                        <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                            <div class="p-4 sm:p-7 flex flex-col border border-gray-200 shadow-lg">
                                <div class="text-center">
                                    <h1 class="block text-3xl font-bold text-gray-800 helvetica-pixel">Signup to create
                                        a fit</h1>
                            ...
                            peer-[:not(:placeholder-shown)]:text-gray-400">Password</label>
                                            ...
                                            <div id="hs-strong-password-popover"
                                                class="hidden absolute z-10 w-full bg-black p-4">
                                ...
                                "mode": "popover"
                                                ...
                                                <h4 class="mt-3 text-sm font-semibold text-gray-200">
                            ...
                            peer-[:not(:placeholder-shown)]:text-gray-400">Repeat password</label>
                                    ...
                                    <div class="mt-5">
                                        <button type="submit"
                                            class="submit-button transition-all w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium border border-transparent bg-gray-900 text-white hover:bg-black focus:outline-none focus:bg-black disabled:opacity-50 disabled:pointer-events-none uppercase helvetica-extended">Get
                                            started</button>
                                    </div>
                                </div>
                            </div>
